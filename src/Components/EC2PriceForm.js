...
class EC2PriceForm extends React.Component {
  ...
  handleSubmit = (event) => {
		...
		var url = "http://localhost:8090/instanceprice?"+"region="+this.state.region+"&instanceType="+this.state.instanceType+"&launchType="+this.state.launchType+"&serviceCode="+this.state.serviceCode+"&osImage="+this.state.osImage;
